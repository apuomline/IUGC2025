...
class densenet_unet(nn.Module):
    def __init__(self, in_chns, class_num, heatmap_size=64, arch='densenet121', pretrained=True, pretrained_path=None):
        ...
        self.arch = arch
        # 用timm创建主干
        self.encoder = densenet121(in_chans=3, num_classes=0, global_pool='', features_only=True,)
    ...
    def forward(self, x):
        ...
        # print(f'output-decoder-shape:{output.shape}')
...
if __name__ == '__main__':
    # 测试densenet121结构
    model = densenet_unet(in_chns=3, class_num=3, arch='densenet121')
